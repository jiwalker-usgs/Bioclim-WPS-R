...
{
nc_filename<-paste(start_year,".nc",sep="")
originDate<-strptime(paste(start_year,"-10-01",sep=""),"%Y-%m-%d")
endDate<-strptime(paste(start_year+1,"-09-30",sep=""),"%Y-%m-%d")
...
nc_time_var <- var.def.ncdf('time','days since 1980-01-01', nc_time_dim, -999, prec='integer')
